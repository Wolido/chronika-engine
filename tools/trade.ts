...
export function registerTradeTool(pi: ExtensionAPI) {
  pi.registerTool({
    ...
    parameters: Type.Object({
      ...
      charisma: Type.Optional(Type.Number({ description: "Charisma skill — -2% buy price, +2% sell price per point" })),
    }),
