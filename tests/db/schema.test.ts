...
describe("DDL_STATEMENTS", () => {
  ...
  it("should contain exactly 15 CREATE TABLE statements", () => {
    ...
    assert.strictEqual(matches!.length, 15, `expected 15 CREATE TABLE, got ${matches!.length}`);
  });

  it("should create all 15 expected tables", () => {
